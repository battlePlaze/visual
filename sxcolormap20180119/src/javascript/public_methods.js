	...
	$.ajax({
		...
		success: function(data) {
			...
			function DoGetPerAreaData(dict_year_data, arr_area_name) {
				...
				return dict_year_data[arr_area_name]["total_population"]
			...
			function DoGetMapColor(dict_year_data, dict_color_map_legend) {
				...
				for(var i in dict_year_data) {
					...
					obj_temp_return["fill"] = DoCalculateCorlor(dict_year_data[i]["total_population"], dict_color_map_legend)
			...
			//获取2016年人口下的雷达图的基础数据
			doHandleDataByNameAndYear(json_data, "per_year_radar_info_", "人口",[],"2016" );
